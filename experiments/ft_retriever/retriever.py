...
def evaluate(retriever, positive):
    retriever_list = open_json(f'ft_retriever/{retriever}/{positive}_positive/retriever.json')
...
if __name__ == '__main__':
    ...
    positives = ['1', '5', '10', '50', '100', '200']

    for retriever in retrievers:
        table = PrettyTable()
        for positive in positives:
            print(f'Evaluating {retriever}')
            columns, row = evaluate(retriever, positive)
